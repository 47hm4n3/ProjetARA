...
public final class Position {
	...
	/**
	 * Calcul d'une nouvelle position à partir d'un module et d'un angle depuis
	 * la position courante.
	 * 
	 * @param module,
	 *            distance de puis la position cournate
	 * @param angle,
	 *            en radian, 0 indique le nord, pi/2 indique l'est, pi indique
	 *            le sud, 3pi/2 indique l'ouest
